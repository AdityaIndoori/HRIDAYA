...
public class Chat extends Activity {
	...
	private void displayData(final byte[] byteArray) {
                    ...
                    if (byteArray != null) {
                        ...
                        //tv.append(data+"\n");
                        TextView numb = (TextView) findViewById(R.id.num);
                        double ddata = Double.parseDouble(data);

                            numb.setText("" + ddata);
                            mSeries1.appendData(new DataPoint(graph2LastXValue, ddata), true, 100);
            ...
            /*mTimer1 = new Runnable() {
                ...
                public void run() {
                    ...
                    double ddata = Double.parseDouble(data);
                    numb.setText(""+ddata);
                    mSeries1.appendData(new DataPoint(graph2LastXValue, ddata), true, 50);
                    graph2LastXValue += 1;

                    mHandler.postDelayed(this, 2000);
                }
            };
            mHandler.postDelayed(mTimer1,1);
*/
